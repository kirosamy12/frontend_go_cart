...
export default function ImprovedAdminDashboard() {
  ...
  // Navigation items
  const navItems = [
    { name: 'Dashboard', icon: BarChart3Icon, href: '/admin' },
    { name: 'Stores', icon: StoreIcon, href: '/admin/stores' },
    { name: 'Users', icon: UsersIcon, href: '/admin/users' },
    { name: 'Orders', icon: PackageIcon, href: '/admin/orders' },
    { name: 'Products', icon: ShoppingBasketIcon, href: '/admin/products' },
    { name: 'Categories', icon: ShoppingCartIcon, href: '/admin/categories' },
    { name: 'Coupons', icon: TrendingUpIcon, href: '/admin/coupons' },
    { name: 'Approve', icon: UserCircleIcon, href: '/admin/approve' },
  ]
