                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
                    {stores.slice(0, 6).map((store) => (
                        <Link 
                            ...
                            className="group bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border border-slate-100 hover:border-indigo-200 flex flex-col items-center"
                        >
                            ...
                            <div className="mt-2 text-xs text-slate-500 text-center">
                                {store.productsCount || Math.floor(Math.random() * 100) + 20} products
                            </div>
                        </Link>
                    ))}
                </div>
